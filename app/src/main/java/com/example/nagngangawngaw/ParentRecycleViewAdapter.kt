...
class ParentRecycleViewAdapter(private val parentItemList : List<Parentitem>)
    :RecyclerView.Adapter<ParentRecycleViewAdapter.ParentRecyclerViewHolder>(){

        inner class ParentRecyclerViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
            val parentImageView : ImageView = itemView.findViewById(R.id.parentLogoTv)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ParentRecycleViewAdapter.ParentRecyclerViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.parent_item, parent , false)
        return ParentRecyclerViewHolder(view)
    }

    override fun onBindViewHolder(holder: ParentRecycleViewAdapter.ParentRecyclerViewHolder, position: Int) {
