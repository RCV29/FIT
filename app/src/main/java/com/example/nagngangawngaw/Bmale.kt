...
import com.example.nagngangawngaw.databinding.ActivityBulkMaleBinding
...
class Bmale : AppCompatActivity() {

    private lateinit var binding: ActivityBulkMaleBinding
    private lateinit var parentRecyclerView: RecyclerView
    private lateinit var parentList : ArrayList<Parentitem>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bulk_male)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_bulk_male)
    ...
    private fun prepareData(){
        ...
        childItem7.add(Childitem("Standing Dumbbell Calf Raises", R.drawable.calfsdcr, getString(R.string.calf_dbcr), R.drawable.calfsdcrs))
        ...
        childItem10.add(Childitem("Diet", R.drawable.dietbs, getString(R.string.bulk_diet), R.drawable.dietb))
        parentList.add(Parentitem("Diet", R.drawable.dietbs ,childItem10))
    }
